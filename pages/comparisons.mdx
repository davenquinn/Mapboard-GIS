...
- TouchGIS provides a ton of capabilities for iPad mapping but is expensive ($299/year).
  ...
  over speed.
- Procreate and GoodNotes are effective tools for drawing, without mapping capabilities. They
  serve as aspirational models for how mapping workflows should work.
