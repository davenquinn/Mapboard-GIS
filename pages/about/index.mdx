...
<Figure src="/docs/line-drawing.mp4" width={500} className="center">Drawing in
**Mapboard GIS** showcases the power of pen-based input.</Figure>
...
<Figure src="/mapboard-topology.mp4" width={500} className="center">Topological
editing in action in **Mapboard GIS**</Figure>
