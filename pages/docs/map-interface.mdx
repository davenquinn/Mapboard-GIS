...
In erase mode, you draw a bounding area which is used to clip
...
The **Settings panel** is a key view that provides access to a range of project
settings not directly related to editing operations.
