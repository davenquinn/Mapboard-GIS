...
<Figure src="/docs/tethered-mode.jpg" className="full">
...
Once you have started the application, the Mapboard server should be running locally on your computer.
...
<Figure src="/docs/macos-sharing-panel.png">
  ...
  my local router allocates IP addresses.
</Figure>

<Figure src="/docs/mapboard-server-connect.jpg" width={300} className="right">
  Entering the server information into the <em>Project edit</em> panel
</Figure>
