...
<Figure
  ...
  width={250}
  className="right"
>A few initially defined geological line types</Figure>
...
<div className="figure-panel">
  <Figure src="/docs/feature-classes/contextual-actions.jpg" width={250}>Long-pressing a data type exposes contextual actions.</Figure>
  <Figure src="/docs/feature-classes/new-type.png" width={250}>The **Data type** editing interface</Figure>
  <Figure
    src="/docs/feature-classes/polygon-types.png" width={250}
  >A typical list of polygon types corresponding to [Macrostrat](https://macrostrat.org) geologic units</Figure>
</div>

The ability to add multiple feature types allows mapping to be customized,
to different field areas and tasks across the geosciences.
