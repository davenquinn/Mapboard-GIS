...
<div className="figure-panel">
  <Figure src="/docs/feature-classes/contextual-actions.jpg" width={300}>Long-pressing a data type exposes contextual actions.</Figure>
  <Figure src="/docs/feature-classes/new-type.png" width={300}>The **Data type** editing interface</Figure>
  <Figure
    src="/docs/feature-classes/polygon-types.png" width={300}
