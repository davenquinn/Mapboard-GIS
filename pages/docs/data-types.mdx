...
At the **Data type selector** page, users can select the data type
to be used for continued mapping. Additionally, new arbitrary data types
can be created for line and polygon
features. **Typically, line features are used for contacts and
